...
the useReouteMatch allows us to be able to nest multiple routes to our application without having to change the entire URL (we can change a sinlge parameter or more).

2. How would you explain form validation to someone who has never programmed before?

Form validation can allow us to display an something like an error message when a something is not filled out properly. Take for example a password, we can use form validation to tell the user that a certain number or characters is needed to fufill the requirements 

3. In 1-2 sentences, define end to end testing.

End to End testing allows us to run tests that would minic interaction. we can use different programs like cypress which will act like a user and follow out instructions that we give it and do those things on the page.
